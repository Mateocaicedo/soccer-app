...
import 'package:soccer_app/screens/leagues/view/widgets/route.dart';
import 'package:repository/src/models/league.dart';

//create a screen for all leagues
// we can tap on any league to see the topscorers
...
class _LeagueViewState extends State<LeagueView> {
  ...
  //create a blocbuilder to get the leagues
  ...
  //create a listviewbuilder to show the leagues
  ...
  //list of actions for the appbar
